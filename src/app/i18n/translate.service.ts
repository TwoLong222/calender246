...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    'notif.cancelled': 'Sự kiện đã bị hủy', 'notif.changed': 'Sự kiện cập nhật', 'notif.fTitle': 'Tiêu đề', 'notif.fStart': 'Ngày giờ bắt đầu', 'notif.fEnd': 'Ngày giờ kết thúc', 'notif.fLocation': 'Địa điểm', 'notif.fDesc': 'Mô tả',
  ...
  en: {
    ...
    'notif.cancelled': 'Event cancelled', 'notif.changed': 'Event updated', 'notif.fTitle': 'Title', 'notif.fStart': 'Start date & time', 'notif.fEnd': 'End date & time', 'notif.fLocation': 'Location', 'notif.fDesc': 'Description',
