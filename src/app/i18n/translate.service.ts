...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    'nav.lightMode': 'Chế độ sáng', 'nav.darkMode': 'Chế độ tối', 'nav.tasks': 'Công việc', 'nav.lunar': 'Âm lịch', 'nav.notes': 'Ghi chú', 'nav.invitations': 'Lời mời',
    'invite.title': 'Lời mời', 'invite.none': 'Không có lời mời nào.', 'invite.from': 'Từ',
    ...
    'theme.custom': 'Tùy chỉnh', 'theme.preview': 'Xem trước', 'theme.reset': 'Về mặc định (xanh navy)',
  ...
  en: {
    ...
    'nav.lightMode': 'Light mode', 'nav.darkMode': 'Dark mode', 'nav.tasks': 'Tasks', 'nav.lunar': 'Lunar calendar', 'nav.notes': 'Notes', 'nav.invitations': 'Invitations',
    'invite.title': 'Invitations', 'invite.none': 'No invitations.', 'invite.from': 'From',
    ...
    'theme.custom': 'Custom', 'theme.preview': 'Preview', 'theme.reset': 'Reset to default (navy)',
