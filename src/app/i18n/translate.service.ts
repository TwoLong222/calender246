...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    'nav.lightMode': 'Chế độ sáng', 'nav.darkMode': 'Chế độ tối', 'nav.tasks': 'Công việc', 'nav.lunar': 'Âm lịch', 'nav.notes': 'Ghi chú',
  ...
  en: {
    ...
    'nav.lightMode': 'Light mode', 'nav.darkMode': 'Dark mode', 'nav.tasks': 'Tasks', 'nav.lunar': 'Lunar calendar', 'nav.notes': 'Notes',
